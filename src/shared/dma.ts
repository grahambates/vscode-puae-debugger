// DMA grid decode: turn the emulator's binary grid into an IDmaModel. Used both extension-side
// (profilerManager.ts, building a captured IProfileModel) and webview-side (screenHover.ts's live
// paused-screen tooltip, profilerBulk.ts's unpackBulk) — zero Node/vscode imports, per this
// project's src/shared/ convention.
// (Reconstruction lives webview-side in src/webview/profilerViewer/reconstruct.ts and
// gfxResources.ts.)
//
...
import { IDmaModel, ICopperModel } from "./profilerTypes";
